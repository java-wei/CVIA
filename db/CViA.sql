...
--
-- Host: localhost:8889
-- Generation Time: Nov 09, 2015 at 11:31 AM
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='Store the CV information' AUTO_INCREMENT=57 ;
...
`job_id` int(10) NOT NULL,
  ...
  `job_duedate` varchar(10) COLLATE latin1_general_ci DEFAULT NULL,
  `job_postdate` varchar(10) COLLATE latin1_general_ci NOT NULL
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='Store the job information' AUTO_INCREMENT=19 ;
...
(2, 'cyj', '$2y$10$DXeIMM1PLEnJNmou1Iuof.lJx3TD57V5u93WY3G9Y/yFBUDnj2qxa', 'chengyingjie29@gmail.com', 'Yes', NULL, 'No');
...
--
ALTER TABLE `cv`
MODIFY `cv_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=57;
--
