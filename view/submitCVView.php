<div id="body">
  ...
  <?php
    echo '<form id="phpCVForm" action="../controller/submitCVController.php?jobID='.$jobID.'" method="post" enctype="multipart/form-data">';
  ?>
  ...
  ?>
      ...
      <label>File Uploaded Successfully...  <a href="../controller/downloadCV.php?id=<?php echo $_GET['cv'] ?>">Click here to view file.</a></label>
  <?php
    }
